  ...
  it "has defined attributes" do
    subject.attributes.keys.map(&:to_s).sort.should ==
      ["account_number", "additional_email_addresses", "allow_invoice_edit", "auto_pay", "balance",
       ...
       "purchase_order_number", "sales_rep_name", "sold_to_id", "status","tax_exempt_certificate_id",
       "tax_exempt_certificate_type", "tax_exempt_description", "tax_exempt_effective_date",
       "tax_exempt_expiration_date", "tax_exempt_issuing_jurisdiction", "tax_exempt_status",
       "total_invoice_balance", "updated_by_id", "updated_date"]
  end
